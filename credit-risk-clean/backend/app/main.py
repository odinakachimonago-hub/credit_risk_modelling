...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3002","https://eclectic-cheesecake-a7a016.netlify.app","https://credit_risk_modelling.netlify.app", "http://127.0.0.1:3002", "http://localhost:5173", "http://127.0.0.1:5173"],
